...
module Wilhelm
  module Virtual
    class CommandConfiguration
      ...
      DEFAULT_COMMAND_NAMESPACE = 'Wilhelm::Virtual::Command'.freeze
      BASE_COMMAND_STRING = 'BaseCommand'.freeze
      PARAMETERIZED_COMMAND_STRING = 'ParameterizedCommand'.freeze

      BASE_COMMMAND_BUILDER_STRING = 'Wilhelm::Virtual::BaseCommandBuilder'.freeze
      PARAMETERIZED_COMMAND_BUILDER_STRING = 'Wilhelm::Virtual::ParameterizedCommandBuilder'.freeze

      WRAPPER = Wilhelm::Virtual::ParameterConfiguration
